...
### Task parameters
DATA_DIR = '/root/autodl-tmp' #f'{os.path.dirname(os.path.realpath(__file__))}/data' 
###state_dim:qpos
TASK_CONFIGS = {
    'grasp_with_force_feedback':{
        'dataset_dir': DATA_DIR + '/grasp_with_force_feeedback',
        'camera_names': ['image_logitech','image_realsense'],
        'observation_name': ['gripper_pos','joint_pos'],
        'state_dim':7,
