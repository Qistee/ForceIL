...
def train_bc(train_dataloader, val_dataloader, config):
    ...
    # ##foece policy
    # force_policy=make_force_policy(policy_config)
...
def main_train(args):
    ...
    #print("state_dim:",state_dim,"state_idx:",state_idx,"action_dim:", action_dim,"action_idx:",action_idx)
    lr_backbone = 1e-5
    backbone = args['backbone']
    if policy_class == 'ACT':
        enc_layers = 4
...
if __name__ == '__main__':
    ...
    parser.add_argument('--same_backbones', action='store_true')##图片处理是否使用同样的backbone
    #use mask
    ...
    PROJECT_NAME = 'Force_imitation'
    WANDB_USERNAME = "quimby-wang"
